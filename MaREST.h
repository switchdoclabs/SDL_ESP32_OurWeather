...
class aREST {
  ...
  private:
    ...
    struct TypedVariable: Variable {
      ...
      TypedVariable(T *v, bool q) : var{v} {
        quotable = q;
      }
  ...
  public:
    ...
    void addHardwareToBuffer() {
      ...
      addToBufferF(F(", \"softwareversion\": "));
      addStringToBuffer(WEATHERPLUSESP32VERSION, true);
